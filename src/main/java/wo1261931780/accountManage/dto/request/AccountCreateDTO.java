...
public class AccountCreateDTO implements Serializable {
    ...
    @Schema(description = "账号名称/登录名", example = "user@example.com", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "密码（明文，后端会加密存储）", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    private Integer hasSecurityTool = 0;
    ...
    private Integer isMainAccount = 1;
